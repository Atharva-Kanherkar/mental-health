...
export class MemoryVaultController {
   ...
   */
  static async getMemoryVault(req: Request, res: Response) {
    try {
   ...
   */
  static async getVaultStats(req: Request, res: Response) {
    try {
      const userId = req.user!.id;
   ...
   */
  static async deleteMemoryVault(req: Request, res: Response) {
    try {
      const userId = req.user!.id;
   ...
   */
  static async searchVault(req: Request, res: Response) {
    try {
      const userId = req.user!.id;
      const query = req.query.q as string;
      const type = req.query.type as string; // 'memories', 'people', or 'all'
