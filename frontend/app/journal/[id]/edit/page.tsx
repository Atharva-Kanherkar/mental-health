...
function EditJournalEntryContent() {
  ...
  const loadJournalEntry = useCallback(async () => {
    try {
      ...
      form.reset({
        ...
        overallMood: entryData.overallMood || undefined,
        energyLevel: entryData.energyLevel || undefined,
        anxietyLevel: entryData.anxietyLevel || undefined,
        stressLevel: entryData.stressLevel || undefined,
        privacyLevel: entryData.privacyLevel,
        convertToMemory: entryData.convertToMemory,
        mediaType: entryData.mediaType || undefined,
        mediaUrl: entryData.mediaUrl || undefined,
      });
    } catch (error) {
  ...
  const onSubmit = async (data: JournalFormData) => {
    ...
    try {
      ...
      const updatedEntry = await journalApi.update(entry.id, data);

      // Show AI analysis results
      setAiAnalysis(updatedEntry.aiAnalysis);
        ...
        <div className="max-w-2xl mx-auto p-8">
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 border border-[#8B86B8]/20 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-serif text-[#6B5FA8] mb-2">Your reflection has been updated</h2>
              <p className="text-[#8B86B8]">Echo has some new insights to share</p>
            </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FAFAFE] via-[#F6F4FC] to-[#F0EDFA]">
        ...
        <div className="max-w-3xl mx-auto px-6">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <span className="font-light">Back to entry</span>
            </Link>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-[#8B86B8] text-lg font-light max-w-xl mx-auto leading-relaxed">
              Sometimes our thoughts need gentle revision. Take your time to update your words and feelings as your heart desires.
            </p>
          </div>
      ...
      {/* Immersive Writing Modal - Same as new entry */}
      {isImmersiveMode && (
            ...
            <div className={`flex items-center justify-between p-4 md:p-6 border-b transition-colors ${
              ...
              <div className="flex items-center space-x-3">
                ...
                <h2 className={`font-serif text-lg transition-colors hidden md:block ${
                  ...
                  {immersiveField === 'title' ? 'Edit your title' : 'Edit your thoughts'}
                </h2>
              </div>
              ...
              <div className="flex flex-col h-full p-4 md:p-6">
                ...
                <div className="flex-1 overflow-y-auto space-y-3">
                  {entriesLoading ? (
                    ...
                    pastEntries.filter(pastEntry => pastEntry.id !== entry.id).map((pastEntry) => (
                      <div
                        key={pastEntry.id}
                        ...
                        onClick={() => window.open(`/journal/${pastEntry.id}`, '_blank')}
                      >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {pastEntry.overallMood && (
                            <span className={`text-xs px-2 py-0.5 rounded-full ${
                              immersiveTheme === 'dark'
                                ? 'bg-white/10 text-white/60'
                                : 'bg-[#6B5FA8]/10 text-[#6B5FA8]'
                            }`}>
                              {pastEntry.overallMood}/10
                            </span>
                          )}
                        </div>
                      </div>
